...
type AmenitiesSection = "requirements" | "amenities" | "all";
...
export function ListingAmenitiesFields({ draft, section = "all", set }: Props) {
  const showRequirements = section === "all" || section === "requirements";
